    ...
    <div class="row">
        <div class="col-md-6 col-sm-6">
            <div class="row">
                ...
                <div class="col-md-12">
                 <img src="" id="respond-1" alt="" height="400px" width="400px" class="mt-4 mr-5">
                 <video id="respond-2" width="400" class="center" style="display:none">
        ...
        <div class="col-md-6 col-sm-6">
            <div class="form-group">
               <label for="exampleFormControlTextarea1"><h5>Deskripsi</h5></label>
                ...
                <input style="width:100%" class="mt-4" value="Upload" type="submit" name="submit" id="">
            </div>
            </div>
        </div>
